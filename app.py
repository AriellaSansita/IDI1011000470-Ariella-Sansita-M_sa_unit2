...
er = int(size0.04)
d.ellipse([size0.32-er, size0.36-er, size0.32+er, size0.36+er], fill="black")
d.ellipse([size0.68-er, size0.36-er, size0.68+er, size0.36+er], fill="black")
if score>=80:
d.arc([size0.28, size0.48, size0.72, size0.78], 0, 180, fill="black", width=4)
elif score>=50:
d.line([size0.36, size0.62, size0.64, size0.62], fill="black", width=4)
else:
d.arc([size0.28, size0.62, size0.72, size0.9], 180, 360, fill="black", width=4)
return img
