...
import turtle  # Added for assignment requirement
...
# ---------------- TURTLE REWARD ----------------
def show_turtle_reward():
    """
    Draws a simple turtle smiley as positive reinforcement.
    """
...
if score==0:
    ...
    if st.button("Celebrate with Turtle 🐢"):
        show_turtle_reward()
