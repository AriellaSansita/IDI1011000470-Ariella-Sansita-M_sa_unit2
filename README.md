...
## Turtle graphics could not be displayed in the deployed Streamlit. Therefore, emojis were used for encouragement is shown in the screenshots. The Turtle code is included in "Turtle" to show the intended design. 
